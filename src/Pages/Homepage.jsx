      ...
      <section className="homepage-section-container">
            ...
            <div className="instructions">
              <div className="instruction-card" id="step-1">
                <div className="instruction-title-container">
                  ...
                  <div className="instruction-card-title-text">
                    <h1 style={{ fontSize: "28px" }}>Upload a File</h1>
                  </div>
                </div>
              ...
              <div className="instruction-card" id="step-2">
                <div className="instruction-title-container">
                  ...
                  <div className="instruction-card-title-text">
                    <h1 style={{ fontSize: "28px" }}>Optiwing Runs</h1>
                  </div>
                </div>
                <p className="instruction-card-p">
              ...
              <div className="instruction-card" id="step-3">
                <div className="instruction-title-container">
                  ...
                  <div className="instruction-card-title-text">
                    <h1 style={{ fontSize: "28px" }}>Results in Minutes</h1>
                  </div>
                </div>
                <p className="instruction-card-p">
            ...
            <div className="pricing-card-grid">
              <div className="pricing-card" id="pcard1">
                <div className="pricing-card-title">
                  <h1 style={{ fontSize: "19px" }}>Basic</h1>
                  <hr></hr>
                </div>
              ...
              <div className="pricing-card" id="pcard2">
                <div className="pricing-card-title">
                  <h1 style={{ fontSize: "19px" }}>Personal</h1>
                  <hr></hr>
                </div>
                <div className="pricing-card-price">
                  <h1>$19</h1>
              ...
              <div className="pricing-card" id="pcard3">
                <div className="pricing-card-title">
                  <h1 style={{ fontSize: "19px" }}>Freelancer</h1>
                  <hr></hr>
                </div>
                <div className="pricing-card-price">
                  <h1>$35</h1>
              ...
              <div className="pricing-card" id="pcard4">
                <div className="pricing-card-title">
                  <h1 style={{ fontSize: "19px" }}>Founder</h1>
                  <hr></hr>
                </div>
                <div className="pricing-card-price">
                  <h1>$59</h1>
              ...
              <div className="pricing-card" id="pcard5">
                <div className="pricing-card-title">
                  <h1 style={{ fontSize: "19px" }}>Consultant</h1>
                  <hr></hr>
                </div>
                <div className="pricing-card-price">
                  <h1>$110</h1>
              ...
              <div className="pricing-card" id="pcard6">
                <div className="pricing-card-title">
                  <h1 style={{ fontSize: "19px" }}>Agency</h1>
                  <hr></hr>
                </div>
                <div className="pricing-card-price">
                  <h1>$199</h1>
        ...
        <div className="call-to-action-wrapper">
          ...
          <div className="call-to-action">
            ...
            <button
              onClick={() => {
                window.location.href = "https://app.optiwing.com/auth/register";
              }}
